...
public class pdp_Gmail_Login_Free_User_17 extends Set {
	...
	public void user_click_on_sign_in_with_google_button_xvii() throws Throwable {
	    ...
	    Thread.sleep(2000);
	    WebElement next_1 = wait.until(ExpectedConditions.elementToBeClickable(By.cssSelector("/html/body/div/div[2]/div[2]/div[1]/form/div/div/input")));
	    Thread.sleep(2000);
	    next_1.click();
	    Thread.sleep(2000);
	    ...
	    Thread.sleep(2000);
	    WebElement next_2 = wait.until(ExpectedConditions.elementToBeClickable(By.cssSelector("/html/body/div[1]/div[2]/div/div[2]/form/span/div/input[2]")));
	    Thread.sleep(2000);
	    next_2.click();
	    Thread.sleep(2000);
	}
